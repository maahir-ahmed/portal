          ...
          <CardContent className="space-y-4">
            ...
            <div className="grid grid-cols-3 gap-4">
              ...
              <div className="space-y-2">
                ...
                <Input id="startTime" name="startTime" type="time" defaultValue={initial?.startTime} required />
              </div>
              <div className="space-y-2">
                <Label htmlFor="endTime">End Time *</Label>
                <Input id="endTime" name="endTime" type="time" defaultValue={initial?.endTime} required />
              </div>
            </div>
            <div className="space-y-2">
